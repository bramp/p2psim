 ...
 *
 */
public class MovingPastryTest extends Default {
	public MovingPastryTest(String[] arglist) throws Exception {
		super(arglist);
		...
		HostSet wifipeers = setupWifiPeers(wifistealth + wifiservice);
