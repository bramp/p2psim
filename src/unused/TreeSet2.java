    ...
    implements SortedSet<E>, Cloneable, java.io.Serializable
{
     ...
     */
    private TreeSet2(SortedMap<E,Object> m) {
        this.m = m;
        keySet = m.keySet();
    }
     ...
     */
    public TreeSet2(Comparator<? super E> c) {
	this(new TreeMap2<E,Object>(c));
    }
	...
	return new TreeSet2<E>(m.subMap(fromElement, toElement));
    }
	...
	return new TreeSet2<E>(m.headMap(toElement));
    }
	...
	return new TreeSet2<E>(m.tailMap(fromElement));
    }
    ...
    public E after(E key) {
    	return (E) ((TreeMap2)m).getAfterKey(key);
    }
	...
	try {
        ...
        clone.m = new TreeMap2<E,Object>(m);
	...
	TreeMap2<E,Object> tm;
	if (c==null)
	    tm = new TreeMap2<E,Object>();
	else
	    tm = new TreeMap2<E,Object>(c);
	m = tm;
        keySet = m.keySet();
